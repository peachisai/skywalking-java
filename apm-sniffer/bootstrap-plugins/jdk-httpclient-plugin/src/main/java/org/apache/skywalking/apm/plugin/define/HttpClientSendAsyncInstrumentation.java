...
public class HttpClientSendAsyncInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    private static final String INTERCEPT_RUN_METHOD = "sendAsync";

    private static final String INTERCEPT_RUN_HANDLE = "org.apache.skywalking.apm.plugin.HttpClientSendInterceptor";
                ...
                new InstanceMethodsInterceptPoint() {
                    ...
                    public ElementMatcher<MethodDescription> getMethodsMatcher() {
                        return ElementMatchers.named(INTERCEPT_RUN_METHOD)
                                ...
                                .and(ElementMatchers.takesArgument(2, named("java.net.http.HttpResponse$BodyHandler")));
                    }
